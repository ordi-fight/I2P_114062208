...
class ChatOverlay(UIComponent):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            self._font_msg = pg.font.Font("assets/fonts/Minecraft.ttf", 20)
            self._font_input = pg.font.Font("assets/fonts/Minecraft.ttf", 20)
        except Exception:
            self._font_msg = pg.font.SysFont(None, 20)
            self._font_input = pg.font.SysFont(None, 20)
    ...
    def draw(self, screen: pg.Surface) -> None:
        ...
        if msgs:
            ...
            bg.fill((255, 255, 255, 90 if self.is_open else 60))
        ...
        txt = self._input_text
        text_surf = self._font_input.render(txt, True, (0, 0, 0))
        _ = screen.blit(text_surf, (x + 8, box_y + 4))
