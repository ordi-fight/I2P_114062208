...
class CatchScene(Scene):
    ...
    def __init__(self):
        ...
        self.pokeball_path = [(1000,100),(850,200),(800,300),(750,250),(740,300),(750,300),(740,300)]
        self.pokeball_sprite = Sprite( "ingame_ui/ball.png" ,(50,50))
  ...
  { "name": "Dragonite", "hp": 180, "max_hp": 250, "attack": 45, "defense": 35, "level": 20, "element": "water", "win_count": 0, "sprite_path": "menu_sprites/menusprite6.png" }
    ...
    def end_battle(self,victor):
        ...
        self._message_timer = 6
        self.is_pokeball = True
        self.pokeball_timer = 6
    ...
    def update(self, dt: float):
        ...
        if self.pokeball_timer>0:
            ...
            if self.pokeball_move_index < len(self.pokeball_path):
            
                if self.timer > 0 :
                        self.timer -= dt
                else:
                    pos = self.pokeball_path[self.pokeball_move_index]
                    self.pokeball_sprite.rect.centerx = pos[0]
                    self.pokeball_sprite.rect.centery = pos[1]
                    self.timer = 0.5
                    self.pokeball_move_index += 1   
        elif self.pokeball_timer <= 0:
            self.is_pokeball = False
    ...
    def draw(self,screen):
        ...
        element.rect.topright = self.enemy_mon_sprite.rect.bottomleft
